...
export const mockTasks: Task[] = [
  {
    ...
    status: "in-progress",
    priority: "high",
    category: "service",  // Changed from string array to string to match Task type
    assigneeId: "member-1",
    reporterId: "member-2",
...
export const mockTransactions: Transaction[] = [
  {
    ...
    amount: 1250.00,
    type: "income",
    category: "Offerings",  // This is correct as string to match Transaction type
...
export const mockProgrammes: Programme[] = [
  {
    ...
    category: "worship",  // This is correct as string to match Programme type
    tags: ["sunday", "service"],
